...
#                       import pdb; pdb.set_trace() 
    ...
    print >> circos_out, 'label_radius     = 1.03r'
    ...
    if options.indetHist:
        ...
        print >> circos_out, 'file             = %s' %options.indetHist
        print >> circos_out, 'color            = black'
        print >> circos_out, 'min              = 0'
        print >> circos_out, 'max              = 1'
        print >> circos_out, 'r0               = 0.955r'
        print >> circos_out, 'r1               = 0.98r'
        print >> circos_out, 'fill_color       = black_a3'
        print >> circos_out, '<rules>'
        print >> circos_out, '<rule>'
        print >> circos_out, 'condition        = var(value) > 0.5'
        print >> circos_out, 'color            = vdred'
        print >> circos_out, 'fill_color       = vdred_a3'
        print >> circos_out, '</rule>'
        print >> circos_out, '</rules>'
        print >> circos_out, '</plot>'
        print >> circos_out, '</plots>'
